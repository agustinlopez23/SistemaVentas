...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService :IVentaService
    {
        ...
        public VentaService(IMapper mapper, IGenericRepository<DetalleVenta> detalleVentaRepository, IVentaRepository ventaRepository)
        {
            _mapper = mapper;
        ...
        public async Task<VentaDTO> Registrar(VentaDTO modelo)
        {
            try
            {
                var ventaGenerada = await _ventaRepository.Resgistrar(_mapper.Map<Venta>(modelo));
